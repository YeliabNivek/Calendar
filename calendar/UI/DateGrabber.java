 ...
 * @author j0ker
 */
public class DateGrabber extends javax.swing.JFrame {

    /**
     * Creates new form DateGrabber
     */
    public DateGrabber() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Warning non-existant dates will not show up on calendar!");

        jLabel4.setText("/");

        jTextField1.setText("year");

        jLabel5.setText("Example: 07/23/2012");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Config.dates.add(Utilities.getMonth(Integer.parseInt((String) jComboBox1.getItemAt(jComboBox1.getSelectedIndex()))) + "/" + jComboBox2.getItemAt(jComboBox2.getSelectedIndex()) + "/" + jTextField1.getText());
        Config.refreshList();
        dispose();
